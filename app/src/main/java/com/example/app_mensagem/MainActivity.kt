...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            App_mensagemTheme(
                selectedTheme = themeViewModel.selectedTheme.value
            ) {
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = startDestination) {
                        ...
                        composable("add_status") {
                            AddStatusScreen(navController, statusViewModel)
                        }

                        composable(
                            route = "view_status/{statusListJson}",
                            arguments = listOf(navArgument("statusListJson") { type = NavType.StringType })
                        ) { backStackEntry ->
